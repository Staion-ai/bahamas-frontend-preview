    ...
    const steps = [
        {
            img: "/step1.png",
            number: "1.",
            title: "Explore & Choose Your Courses",
            desc: "Browse the 50+ courses across categories and pick the top 3 options that excite you the most. Each course is fully online and self-paced, so you can learn at your own pace.",
        },
        {
            img: "/step2.png",
            number: "2.",
    ...
    return (
        ...
        >
            {steps.map((step, index) => (
                ...
                >
                    {/* ICON */}
                    <div className="w-20 h-20 rounded-full bg-cyan-400 border-2 border-black flex items-center justify-center mb-12 overflow-hidden">
                        <img
                            src={step.img}
                            alt={step.title}
                    ...
                    <div className="flex flex-row items-end gap-3 mb-12">
                        <h3 className="text-5xl leading-none">{step.number}</h3>
                        <p className="text-lg sm:text-xl m-0">{step.title}</p>
                    </div>
