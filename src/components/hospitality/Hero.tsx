    ...
    <>
        <div className="w-full h-[auto] bg-white flex flex-col justify-center items-center gap-0 pt-3
            ...
            <div className="w-[80%] h-[45%] text-black
                ...
                <h1 className="text-[48px] font-bold leading-none md:text-[62px] md:font-bold">Hospitality & Customer service</h1>

                <span className="inline-block w-[100%] h-[2px] bg-cyan-300
                                md:w-[100%]"></span>


                <p className="text-[28px] font-bold md:text-32px">&quot;I&apos;m passionate about creating experiences for others&quot;</p>
            </div>
