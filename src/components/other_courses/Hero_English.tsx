    ...
    <>
        <div className="w-full h-[auto] bg-white rounded-b-4xl flex flex-col justify-center items-center gap-0 pt-3
            ...
            <div className="w-[80%] h-[45%] text-black bg-[100px]
                ...
                <h1 className="text-[48px] font-bold leading-none md:text-[54px] md:font-bold">Advanced english for specific purposes</h1>

                <span className="inline-block w-[100%] h-[2px] bg-cyan-300
                                md:w-[100%]"></span>

                <p className="text-[24px] font-bold md:text-32px">&quot;I want to master English for professional and business purposes and open new doors.&quot;</p>
            </div>
