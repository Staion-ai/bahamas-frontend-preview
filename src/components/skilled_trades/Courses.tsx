  ...
  return (
    <>
        <div className="w-full h-[auto] flex flex-col items-center pt-10 bg-[#0C1C44]">
            <p className="w-[90%] md:w-[80%] text-white text-[20px]"> Practical skills in trades and operations open doors to steady work and entrepreneurship.
            ...
            {courses.map((courses, index) => (
                <div key={index} className="w-[90%] h-[auto] flex flex-col text-white border border-solid border-cyan-400 rounded-[20px] p-3 mb-10
